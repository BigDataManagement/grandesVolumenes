...
DROP TABLE IF EXISTS sakila_olap.payment_fact;
CREATE TABLE sakila_olap.payment_fact (
  payment_id smallint(5) unsigned NOT NULL AUTO_INCREMENT,
  time_id INT(11) NOT NULL,
  cantidad_pagos_dia SMALLINT NOT NULL,
  PRIMARY KEY (payment_id),
  KEY idx_fk_time_id (time_id),
  CONSTRAINT fk_payment_time FOREIGN KEY (time_id) REFERENCES sakila_olap.time_dimension (time_id) ON DELETE RESTRICT ON UPDATE CASCADE
